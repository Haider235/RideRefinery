            ...
            <div class="bg-white shadow-sm sm:rounded-lg p-6">
                ...
                <form action="{{ route('admin.brands.update', $brand) }}" method="POST" enctype="multipart/form-data" class="space-y-6">
                    ...
                    <div>
                        ...
                        @if($brand->logo)
                            <div class="mt-2">
                                <img src="{{ asset('storage/'.$brand->logo) }}" alt="Brand Logo" class="h-24 w-24 object-cover rounded border">
                            </div>
                        @endif
                    ...
                    <div class="flex items-center space-x-4">
                        <button type="submit" class="px-4 py-2 bg-indigo-600 text-white rounded-md hover:bg-indigo-700 text-xs font-semibold uppercase tracking-widest">Update Brand</button>
