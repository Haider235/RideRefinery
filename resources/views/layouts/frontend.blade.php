...
<body class="bg-gray-50 text-gray-900">
    ...
    <header class="bg-white shadow">
        <div class="container mx-auto flex items-center justify-between py-4 px-6">
            ...
            <nav class="space-x-4 flex">
                ...
                <a href="{{ route('support.create') }}" class="hover:text-red-600">Customer Support</a>
                <a href="{{ route('cart') }}" class="hover:text-red-600">Cart</a>
                <a href="{{ route('frontend.spareparts.index') }}" class="hover:text-red-600">Spare Parts</a> {{-- ✅ New Link --}}
    ...
    <!-- Footer -->
    <footer class="bg-gray-800 text-gray-300 py-6 px-4">
        <div class="container mx-auto grid grid-cols-1 md:grid-cols-3 gap-6 text-center md:text-left">
            ...
            <div>
                ...
                <ul>
                    ...
                    <li><a href="{{ route('frontend.spareparts.index') }}" class="hover:text-white">Spare Parts</a></li> {{-- ✅ Added in footer --}}
            ...
            <div>
                ...
                <ul>
                    ...
                    <li><a href="{{ route('request.consultation') }}" class="hover:text-red-600">Contact</a></li>
                </ul>
            </div>

            <!-- Legal & Info -->
            <div>
                <h4 class="font-bold mb-2">About Company</h4>
                <p>We are a leading provider of bike services, offering a wide range of solutions to meet your cycling needs. Our team of experts is dedicated to ensuring your bike is in top condition, providing everything from maintenance to custom modifications.</p>
            </div>
